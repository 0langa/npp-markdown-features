...
constexpr UINT NPPM_DOOPEN = 2101;  // NPPMSG + 77
constexpr UINT NPPM_GETMENUHANDLE = 2049;
constexpr UINT NPPM_DMMSHOW = 2054;
constexpr int IDM_FILE_NEW = 41001;
...
constexpr UINT SCI_WORDENDPOSITION = 2267;
